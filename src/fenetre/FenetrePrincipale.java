...
import Controlleur.ControllerCategorie;
...
public class FenetrePrincipale extends JFrame implements ActionListener,
	...
	private java.util.List<String> listeCategories;
	private I_CategorieDAO dao;

	
	public FenetrePrincipale(I_Catalogue c, FenetreAccueil f,java.util.List<String> names, I_CategorieDAO dao) {
		catalogue=c;
		setTitle("exercice Produits");
		accueil=f;
		this.dao=dao;
		listeCategories=new ArrayList<>(names);
...
//		String[] tabCategories = new String[] {"Bio", "Luxe" };		
		...
		if (e.getSource() == btNouveauProduit)			
			ControllerCreerSupprimer.afficherAjouter(this,catalogue,listeCategories);
		if (e.getSource() == btSupprimerProduit)			
			ControllerCreerSupprimer.afficherSupprimer(this,catalogue);
		if (e.getSource() == btNouvelleCategorie)
			ControllerCategorie.NouvelleCategorie(dao);
		if (e.getSource() == btSupprimerCategorie)
			ControllerCategorie.SupprimerCategorie(dao,listeCategories);			
